...
% Grey Wolf Optimizer
function [Alpha_score,Alpha_pos,Convergence_curve]=GWO(SearchAgents_no,Max_iter,lb,ub,dim,handles,Value)
...
while l<Max_iter
    ...
    fprintf('The current iteration is ', num2str(l));
    fprintf('The current optimal value is ', num2str(Alpha_score));
